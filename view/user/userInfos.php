...
<div class="form-group">
							...
							<input type="text" class="form-control login" name ="login" id="login" placeholder="<?php echo $data['login'] ?>">
						
						</div>
						<div class="form-group">
							<label for="email">Email</label>
							<input type="text" class="form-control" name ="email" id="email" placeholder="<?php echo $data['email'] ?>" >
						</div>
